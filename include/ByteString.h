...
public:
    ...
    ByteString &
    operator=(const ByteString &other);

    ByteString &
    operator=(ByteString &&other);
     ...
     */
    ByteString
    append(const ByteString &b) const;

    ByteString
    append(const byte *bytes, size_t bytes_length) const;
     ...
     */
    ByteString
    replace(const ByteString b, size_t begin_pos) const;

    ByteString
    replace(const byte *bytes, size_t bytes_length, size_t begin_pos) const;
     ...
     */
    ByteString
    insert(const ByteString b, size_t pos) const;

    ByteString
    insert(const byte *bytes, size_t bytes_length, size_t pos) const;
     ...
     */
    ByteString
    sub(size_t begin_pos, size_t end_pos) const;
    ...
    bool
    operator==(const ByteString &o) const;

    bool
    operator!=(const ByteString &o) const;

    friend std::ostream &
    operator<<(std::ostream &out, const ByteString &b);
};